...
class sweep1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 14980, 0.5)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 0.5, 1, 0, 0)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 1.003)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 200, 2400, 1, window.WIN_HANN, 6.76))
