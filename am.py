...
class am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(240000, analog.GR_COS_WAVE, 600, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(480000, analog.GR_COS_WAVE, 100e3, 1, 0, 0)
